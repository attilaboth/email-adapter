...
class EmailCrudServiceImplTest {
    ...
    Optional<EmailDTO> testEmail;

    @BeforeEach
    void setUp() {
        testEmail = Optional.of(EmailDTO.builder().emailId("cab35c05-681f-44dc-a34d-1b3335873c5a")
                .subject("testSubject")
                .sender("Rashid")
                .recipient("Kumar")
                .build());
    ...
    void findAll() {
        ...
        Set<Optional<EmailDTO>> mails;

        emails.add(Optional.of(EmailDTO.builder().emailId("3d7df87e-8325-46f9-87cd-5a91460f8a26").build()));
        emails.add(Optional.of(EmailDTO.builder().emailId("ab758c42-d86b-49d2-9ca3-8e0f6a651921").build()));
    ...
    void findById() {
        ...
        Optional<EmailDTO> emailDTO = emailCrudServiceImpl.findById("def651ee-cdc0-403e-b052-1737c268dbf7");
    ...
    @Test
    void save() {
        Optional<EmailDTO> emailToSave = Optional.of(EmailDTO.builder().emailId("def651ee-cdc0-403e-b052-1737c268dbf7").build());
        when(emailRepository.save(any())).thenReturn(emailToSave);

        Optional<EmailDTO> savedEmail = emailCrudServiceImpl.save(emailToSave);
